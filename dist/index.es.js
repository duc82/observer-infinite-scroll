import c, { forwardRef as R, useState as v, useRef as d, useEffect as x, useLayoutEffect as L, useImperativeHandle as h } from "react";
const C = R(
  ({
    fetchMore: u,
    hasMore: o,
    ...
    options: f = { rootMargin: "100px 0px 100px 0" },
    position: r = "bottom",
    className: b,
    style: E,
    children: p
    ...
    return x(() => {
      ...
      if (!e || r !== "top")
        return;
      const n = a.scrollHeight, i = a.scrollTop, l = e.scrollHeight, I = i + (l - n);
      e.scrollTop = I;
